...
export type PrivateSlotStatus = "available" | "locked" | "cancelled"
...
export interface PrivateSlotInput { coachProfileId?: string | null; startAt: string; endAt: string }
export interface PrivateSlotList { items: PrivateSlot[]; total: number }
export interface PrivateWeekInput { coachProfileId?: string | null; weekStart: string; weekdays: number[]; startTime: string; durationMinutes: number }
...
export interface PrivateBookingList { items: PrivateBooking[]; total: number; skip: number; limit: number }
export interface PrivateBookingInput { availabilityId: string; memberMessage?: string | null }
export interface PrivateBookingDecisionInput { reason?: string | null }
export interface PrivateLessonRecordInput { content: string; consumedHours: string; memberStatusNotes?: string | null }
...
export interface ReportSummary {
  ...
  privateConsumedHours: string
  privateCompletionRate: number
}
...
export interface ReportQuery { dateFrom?: string; dateTo?: string; coachId?: string; courseId?: string; cardProductId?: string }
